...
def main():
    ...
    problem_params['nvars'] = [(256, 256)]  # number of degrees of freedom for each level
    problem_params['filename'] = 'heat2d_dump_256x256.npz'
    ...
    print('CFL number: %4.2f' % (level_params['dt'] * problem_params['nu'] / (1.0 / problem_params['nvars'][0][0])**2))
